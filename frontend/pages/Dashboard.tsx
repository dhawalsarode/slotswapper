    ...
    <Layout>
      <div className="space-y-6">
        ...
        <Alert severity="info" variant="outlined">
          <strong>How to use SlotSwapper:</strong> <br />
          1. Create events using the "+ Create Event" button. Note that all new events are 'SWAPPABLE' by default. <br />
          2. Toggle event status between 'BUSY' and 'SWAPPABLE' using the button on each event card. <br />
          3. Select events from your calendar to initiate or respond to swap requests.
        </Alert>
